...
-- Instances:
local Converted = {
	["_Haxorz"] = Instance.new("ScreenGui");
...
Converted["_Haxorz"].DisplayOrder = 999
Converted["_Haxorz"].IgnoreGuiInset = true
Converted["_Haxorz"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_Haxorz"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_Haxorz"].Name = "Starlight"
Converted["_Haxorz"].Parent = game:GetService("CoreGui")
...
Converted["_Frame"].Parent = Converted["_Haxorz"]
...
Converted["_ImageLabel"].Image = "rbxassetid://93401970176800"
...
local function QOXL_fake_script() -- Fake Script: StarterGui.Hax0rz.str.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_str"]
    local req = require
